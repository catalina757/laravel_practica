                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button class="btn btn-xs btn-primary mr-3" type="button"
                                                    onclick="prepareToEdit({{ $user->id }})" data-toggle="modal"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-default" data-dismiss="modal"
                                            onclick="cancelEditConfirmation()">Close
                                    </button>
                                    <button type="submit" class="btn btn-primary" onclick="willEdit()">Save changes
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer justify-content-around">
                                ...
                                <button type="button" class="btn btn-default" data-dismiss="modal"
                                        onclick="cancelDeleteConfirmation()">Cancel
                                </button>
                            </div>
                        </div>
                        <!-- /.modal-content -->
